...
}> = ({ title, subtitle, tool, desc, icon, color, citations }) => (
    <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:scale-[1.01] transition-all duration-300">
        ...
        <div className="mb-6 inline-block px-3 py-1 bg-slate-100 rounded-lg text-[10px] font-black uppercase text-slate-500 tracking-wider">
            {tool}
        </div>
...
const MethodsPage: React.FC<MethodsPageProps> = ({ onBack, onStart, t }) => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 pb-24">
            ...
            <div className="max-w-5xl mx-auto px-6 pt-32 sm:pt-40 pb-24">
